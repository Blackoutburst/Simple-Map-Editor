package dev.blackoutburst.mapeditor.window

import dev.blackoutburst.mapeditor.input.Keyboard
import dev.blackoutburst.mapeditor.input.Mouse
import dev.blackoutburst.mapeditor.maths.Vector2i
import dev.blackoutburst.mapeditor.utils.IOUtils
import dev.blackoutburst.mapeditor.utils.Time
import dev.blackoutburst.mapeditor.utils.stack
import dev.blackoutburst.mapeditor.window.callbacks.*
...
object Window {
    val title = MemoryStack.stackPush().UTF8("Simple Map Editor")
    var id = -1L
    var isOpen = false
